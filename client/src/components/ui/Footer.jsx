...
const Footer = () => {
  return (
    <>
    <div className="my-4 w-full border-[1px] border-white-200"></div>
      ...
      <div className="flex w-full max-w-screen-xl flex-col items-center px-6">
        ...
        <div className="grid  w-full grid-cols-1 gap-4 py-8 text-sm md:grid-cols-3  ">
          <div className="flex flex-col gap-1">
            ...
            <p>
              <span className="cursor-pointer font-normal text-light decoration-1 underline-offset-1 hover:underline">
                Help Center
              </span>
            </p>
            <p>
